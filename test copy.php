    ...
    <div class="cardSection1">
        ...
        <div class="card">
            ...
            <div class="cardContent">
                ...
                <p id="<?php "'#pText' . $id . '" ?>" class=" <?php echo "' . $class . '" ?>">
                    <?php
                    $longContent13 = " Dogs are big on instinct and they bounce off the happy energy we have when we’re around them.
                        Bubbly
                        and cuddly go together well. Bring your fine furry friends over for some serious pampered dog
                        grooming at our salon.";
                    $shortContent13 = substr($longContent13, 0, 150) . '...';
                    expandable_text(13, $shortContent13, $longContent13);
                    ?>
                </p>
            </div>
        </div>
